...
function Colors(){
    ...
    return(
        ...
        <div className="color-column">
              <div className="color" onClick={(e) => dispatch(dispatchSelectedColor(e.target.id))} style={{backgroundColor: "#ffffff"}} id="#ffffff"></div>
              <div className="color" onClick={(e) => dispatch(dispatchSelectedColor(e.target.id))} style={{backgroundColor: "#e6e6e6"}} id="#e6e6e6"></div>
              <div className="color" onClick={(e) => dispatch(dispatchSelectedColor(e.target.id))} style={{backgroundColor: "#cdcdcd"}} id="#cdcdcd"></div>
              <div className="color" onClick={(e) => dispatch(dispatchSelectedColor(e.target.id))} style={{backgroundColor: "#b4b4b4"}} id="#b4b4b4"></div>
              <div className="color" onClick={(e) => dispatch(dispatchSelectedColor(e.target.id))} style={{backgroundColor: "#9b9b9b"}} id="#9b9b9b"></div>
              <div className="color" onClick={(e) => dispatch(dispatchSelectedColor(e.target.id))} style={{backgroundColor: "#828282"}} id="#828282"></div>
              <div className="color" onClick={(e) => dispatch(dispatchSelectedColor(e.target.id))} style={{backgroundColor: "#696969"}} id="#696969"></div>
              <div className="color" onClick={(e) => dispatch(dispatchSelectedColor(e.target.id))} style={{backgroundColor: "#505050"}} id="#505050"></div>
              <div className="color" onClick={(e) => dispatch(dispatchSelectedColor(e.target.id))} style={{backgroundColor: "#FF0000"}} id="#FF0000"></div>
